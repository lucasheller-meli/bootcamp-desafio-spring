...
public class PopulateDatabase implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        promotionalPostRepository.saveAll(List.of(
                PromotionalPost.builder().user(rodrigo).product(cadeira).category(1).price(1200.0).date(LocalDate.now().minusDays(2)).hasPromotion(true).discount(0.22).build(),
                PromotionalPost.builder().user(rodrigo).product(cadeira).category(1).price(1800.0).date(LocalDate.now().minusWeeks(3)).hasPromotion(true).discount(0.21).build(),
                PromotionalPost.builder().user(marianne).product(cadeira).category(1).price(900.0).date(LocalDate.now().minusDays(4)).hasPromotion(true).discount(0.37).build(),
                PromotionalPost.builder().user(marianne).product(cadeira).category(1).price(1900.0).date(LocalDate.now().minusWeeks(4)).hasPromotion(true).discount(0.51).build(),
                PromotionalPost.builder().user(lucas).product(cadeira).category(1).price(1400.0).date(LocalDate.now().minusDays(5)).hasPromotion(true).discount(0.25).build(),
                PromotionalPost.builder().user(lucas).product(cadeira).category(1).price(1700.0).date(LocalDate.now().minusWeeks(4)).hasPromotion(true).discount(0.03).build(),
                PromotionalPost.builder().user(carolina).product(monitor).category(6).price(2152.20).date(LocalDate.now().minusDays(2)).hasPromotion(true).discount(0.33).build(),
                PromotionalPost.builder().user(thamirez).product(notebook).category(99).price(30329.0).date(LocalDate.now().minusDays(8)).hasPromotion(true).discount(0.18).build()
        ));
    }
}
